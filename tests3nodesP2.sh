...
#SBATCH --job-name=P2MatFreeKMV_3nodes_15to60
...
mpiexec -n 35 python ico_experiments.py
mpiexec -n 40 python ico_experiments.py
mpiexec -n 60 python ico_experiments.py
