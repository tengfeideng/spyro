...
#SBATCH --job-name=test1coreand4coreand8coreand10coreMatFreeKMV
...
mpiexec -n 1  python ico_experiments.py
mpiexec -n 4  python ico_experiments.py
mpiexec -n 8  python ico_experiments.py
mpiexec -n 10 python ico_experiments.py
