...
#SBATCH --job-name=P4MatFreeKMV_3nodes_15to60
...
mpiexec -n 15 python ico_experiments4.py
mpiexec -n 20 python ico_experiments4.py
mpiexec -n 25 python ico_experiments4.py
mpiexec -n 30 python ico_experiments4.py
mpiexec -n 35 python ico_experiments4.py
mpiexec -n 40 python ico_experiments4.py
mpiexec -n 60 python ico_experiments4.py
